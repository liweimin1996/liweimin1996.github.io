...
# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[Min Blog](https://liweimin1996.github.io)搭建出来了。。。
...
注册完成后搜索 `liweimin1996.github.io` 进入[我的仓库](https://github.com/liweimin1996/liweimin1996.github.io)
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`liweimin1996.github.io`
...
keyword: "Min, Blog, iOS, Apple, iPhone" #关键词
url: "https://liweimin1996.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
sidebar-avatar:/img/avatar-Min.JPG      # 你的个人头像 这里你可以改成我在img文件夹中的两张备用照片 img/avatar-m 或 avatar-g
```
#### 社交账号
展示你的其他社交平台
...
新加入了**简书**，`jianshu_id` 在你打开你的简书主页后的地址如：`http://www.jianshu.com/u/e719`中，后面这一串数字：`e719`
...
disqus_username: liweimin
```

> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](http://liweimin.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
# Analytics settings
# Baidu Analytics
ba_track_id: 83e259f69b37d02a4633

# Google Analytics
ga_track_id: 'UA-908596-1'            # Format: UA-xxxxxx-xx
ga_domain: auto
```
...
搭建好博客之后 你可能不想直接使用 [liweimin1996.github.io](http://liweimin1996.github.io) 这么长的博客域名吧, 想换成想 [liweimin.top](http://liweimin.top) 这样简短的域名。那我们开始吧！

#### 购买域名
首先，你必须购买一个自己的域名。

我是在[阿里云](https://wanwang.aliyun.com/domain)购买的域名
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `liweimin.top` 的域名第一年才只要20元~
...
一个主机记录为 `www`,代表可以解析 `www.liweimin.top`的域名

另一个为 `@`, 代表 `liweimin.top`
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/liweimin1996/liweimin1996.github.io) 点个 **star** 吧！

因为最近发现 Fork 将近破百，加上直接 Clone 仓库的，保守估计已经帮助上百人成功的搭建了自己的博客，~~可是 Star 却仅仅只有 **12**！可能还是做的不够好吧！~~现在已经破百了，感谢大家的Star！

### **别无他求，点个 [Star](https://github.com/liweimin1996/liweimin1996.github.io) 吧**！
